    ...
    <p v-for="keys in keyList">
      <template v-for="key in keys">
        ...
        <i
          ...
          @click.stop="clickKey"
          @touchend.stop="clickKey"
          class="iconfont icon-konggejian-jianpanyong tab-blank"
        ></i>
        <i
        ...
        <i
          ...
          @click.stop="clickKey"
          @touchend.stop="clickKey"
          class="iconfont icon-huiche tab-enter"
        ></i>
        <i
          v-else
          @click.stop="clickKey"
...
<script>
import clickoutside from "../assets/js/dictionary";
